        ...
        {!submitted ? (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6 text-left mt-8">
              <input type="hidden" name="_subject" value="Nowa wiadomość z formularza kontaktowego – Luisówka" />
              <input type="hidden" name="Typ formularza" value="Formularz kontaktowy na stronie Luisówka" />
              ...
              <div className="flex flex-col">
                <label htmlFor="email" className="mb-1 font-semibold">Adres e-mail</label>
                <input
                  type="email"
                  id="email"
                  name="E-mail"
