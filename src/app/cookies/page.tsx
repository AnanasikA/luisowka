    ...
    <main className="bg-[#fdfbf7] min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex justify-center px-4 py-16 md:py-24">
        <div className="bg-white/70 border border-[#3f4a3c] shadow-xl backdrop-blur-md rounded-2xl max-w-3xl w-full text-[#3f4a3c] p-6 md:p-10">
          ...
          <p className="mb-4">
            Niniejsza polityka prywatności wyjaśnia, w jaki sposób przetwarzamy Twoje dane osobowe podczas korzystania ze strony internetowej Luisówka – domek w górach.
          </p>
          ...
          <p className="mb-4">
            Masz prawo do: dostępu do swoich danych, ich sprostowania, usunięcia, ograniczenia przetwarzania oraz wniesienia skargi do organu nadzorczego.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-3">5. Cookies</h2>
          <p className="mb-4">
            Korzystamy z plików cookies do celów technicznych i analitycznych. Szczegóły znajdziesz w <Link href="/cookies" className="underline">polityce cookies</Link>.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-3">6. Bezpieczeństwo danych</h2>
          <p className="mb-4">
            Dokładamy wszelkich starań, aby Twoje dane były bezpieczne – korzystamy z szyfrowania (SSL) oraz bezpiecznego systemu baz danych (Firebase).
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-3">7. Kontakt</h2>
          <p className="mb-4">
            W sprawach związanych z ochroną danych osobowych prosimy o kontakt na adres e-mail: <a href="mailto:kontakt@luisowka.com" className="underline">kontakt@luisowka.com</a>.
          </p>
